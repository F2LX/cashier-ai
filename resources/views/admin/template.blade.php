...
<head>
    ...
    <title>CASHPER Admin Dashboard</title><!--begin::Primary Meta Tags-->
    ...
    <link rel="stylesheet" href="{{ asset('alte/css/adminlte.css') }}"><!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
      ...
      <!--begin::Fullscreen Toggle-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="bi bi-person-circle"></i>
                        <span class="d-none d-md-inline ms-1"> Felix Febryan Wana</span> </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            <li class="user-header text-bg-primary"> <i class="bi bi-person-circle"></i>

                                <p>
                                    Felix Febryan Wana - Web Developer
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item"> <a href="./manage" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Manage Product</p>
                                    </a> </li>
                            </ul>
                        </li>
        ...
        <footer class="app-footer"> <!--begin::To the end-->
            <div class="float-end d-none d-sm-inline">CASHPER</div> <!--end::To the end--> <!--begin::Copyright--> <strong>
                Copyright &copy; 2024&nbsp;
                <a href="https://adminlte.io" class="text-decoration-none">CASHPER</a>.
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer> <!--end::Footer-->
